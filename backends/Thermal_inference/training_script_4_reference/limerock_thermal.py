...
def run(cfg: PhysicsNeMoConfig) -> None:
    ...
    interface = PointwiseBoundaryConstraint(
        ...
        criteria=y > limerock.copper_base_y,
    ...
    # limerock base
    sharpen_tanh = 60.0
    # source_origin: (sim_x_start, bottom_face_y, sim_z_start)
    ...
    base = PointwiseBoundaryConstraint(
        ...
        criteria=(y < limerock.copper_base_y + 1e-4) & (y > limerock.copper_base_y - 1e-4),
    ...
    def mask_fn(x, y, z):
        # Keep only the STL solid in the exported VTK.
        sdf = limerock.geo_solid.sdf({"x": x, "y": y, "z": z}, {})
        return sdf["sdf"] < 0
    ...
    #     10000, criteria=Eq(y, limerock.geo_bounds_lower[1])
    # )
