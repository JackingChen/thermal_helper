...
# source
# Heat source chip ~30x30 mm, centered at (sim_x=95mm, sim_z=270mm) 
scale_value = 100
source_term = 2127.71  # K/m
# left corner of source term, in (x, y, z) format.
source_origin = (100/scale_value, limerock.geo_bounds_lower[1], 255/scale_value)  # (, y_min)
source_dim = (30/scale_value, 0, 30/scale_value)  

################
# Non dim params
################
length_scale = 0.01  # m
velocity_scale = 1  # m/s
